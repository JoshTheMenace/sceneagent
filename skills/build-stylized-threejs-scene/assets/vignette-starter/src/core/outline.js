 ...
 * objects -- the hero prop, the interactable, the landmark -- want a
 ...
 *
 * Ported from Sakura Crossing's src/core/outline.js; the default ink
 * colour lives in DEFAULTS instead of the flagship palette.
 * ------------------------------------------------------------------ */

const DEFAULTS = {
  ink: 0x3a3450, // keep in step with the palette's ink role
};
 ...
 */
export function hullOutline(mesh, { thickness = 0.0038, color = DEFAULTS.ink, opacity = 1 } = {}) {
